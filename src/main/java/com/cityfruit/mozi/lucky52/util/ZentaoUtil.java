...
public class ZentaoUtil {
    ...
    public static String getSearchResult(Integer searchType, String zentaoCookie, String productId) {
        ...
        buildSearchQueryParam.get(searchType).replace("actionURL", "/bug-browse-" + productId + "-0-bySearch-myQueryID.html");
        // 请求搜索条件
        HttpUtil.post(UrlConst.ZENTAO_BUILD_SEARCH_QUERY, buildSearchQueryParam.get(searchType), zentaoCookie, HttpUtil.CONTENT_TYPE_FORM_URLENCODED);
